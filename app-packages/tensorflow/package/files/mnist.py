...
flags.DEFINE_string("data_dir", "hdfs://cisl-linux-090/user/hadoop/mnist-data",
                    "Directory where the mnist data is stored")
flags.DEFINE_string("train_dir", "/tmp/tf_on_yarn",
...
def device_and_target():
    ...
    cluster_spec = tf.train.ClusterSpec({
        "ps": normalize_hosts(FLAGS.ps_hosts.split(",")),
        "worker": normalize_hosts(FLAGS.worker_hosts.split(",")),
    })
